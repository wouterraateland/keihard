    ...
    <Column size={4}>
      <Share href={`https://facebook.com/sharer.php?u=${url}`}>
        <svg id="facebook" viewBox="0 0 17 16" width="100%" height="100%">
          ...
          <path
            d="M15.37 0H.9C.402 0 0 .395 0 .883v14.234c0 .488.402.883.898.883H8.69V9.804H6.57V7.39h2.12V5.607c0-2.066 1.283-3.19 3.158-3.19.898 0 1.67.064 1.894.094v2.16h-1.3c-1.02 0-1.217.476-1.217 1.176v1.54h2.432l-.317 2.416h-2.115V16h4.146c.497 0 .9-.395.9-.883V.883c0-.488-.403-.883-.9-.883"
            fillRule="evenodd"
          ></path>
        </svg>
      </Share>
    ...
    <Column size={4}>
      <Share href={`mailto:?body=${emailBody}`}>
        <svg id="mail" viewBox="0 0 20 14" width="100%" height="100%">
          ...
          <path
            d="M0 12.356l5.6-5.65L0 1.526v10.83zm9.628-3.79c.23 0 .463-.09.657-.27L18.987.25c.097-.09.03-.25-.105-.25H.374C.238 0 .172.16.27.25l8.7 8.046c.195.18.427.27.658.27zm4.026-1.86l5.602 5.65V1.527l-5.602 5.18zm-2.578 2.546c-.402.36-.916.56-1.448.56-.532 0-1.047-.2-1.45-.56L6.427 7.675.444 13.542c-.164.162-.045.436.19.436h17.987c.238 0 .357-.274.19-.436l-5.98-5.867-1.754 1.577z"
            fillRule="evenodd"
          ></path>
        </svg>
      </Share>
